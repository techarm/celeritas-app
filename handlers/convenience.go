...
func (h *Handlers) renderGoPage(w http.ResponseWriter, r *http.Request, tmpl string, variables any) error {
	return h.App.Render.GoPage(w, r, tmpl, variables)
}

func (h *Handlers) renderJetPage(w http.ResponseWriter, r *http.Request, tmpl string, variables, data any) error {
...
func (h *Handlers) sessionHas(ctx context.Context, key string) {
	h.App.Session.Exists(ctx, key)
}
